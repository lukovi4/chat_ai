...
void main() {
  // Required test 4: SDP signaling is exactly one POST, application/sdp, with
  // the ephemeral secret as the ONLY credential and no redirect following.
  test(
  ...
  test('a non-2xx signaling status throws without leaking the body', () async {
    ...
    expect(caught, isA<VoiceProbeConnectException>());
...
class _FakeRequest implements HttpClientRequest {
  ...
  Future<HttpClientResponse> close() async =>
      _FakeResponse(statusCode: statusCode, body: body);

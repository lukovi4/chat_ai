// A memoized, exactly-once teardown coordinator for one voice session. Mirrors
// the accepted feasibility probe's exactly-once release idea, re-implemented
// package-locally (the probe's ProbeRelease and the removed transport's
// RealtimeSetupRelease are not touched here).
//
// Guarantees:
...
//   adopted and closed immediately (cancel-during-signaling safety), and the
//   returned future settles only once that close has finished;
